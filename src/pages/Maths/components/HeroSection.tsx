...
const HeroSection: React.FC<HeroSectionProps> = memo(({ childName = 'Math Magician', classDetails, code }) => {
  ...
  useEffect(() => {
    ...
    const handle: number | ReturnType<typeof window.requestIdleCallback> | undefined = idleCb
