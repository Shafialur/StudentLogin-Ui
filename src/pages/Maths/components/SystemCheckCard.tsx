    ...
    <div className="bg-system-card backdrop-blur-sm lg:backdrop-blur-md backdrop-saturate-[150%] border-2 border-gray-300 rounded-2xl p-2.5 sm:p-3 lg:p-3 flex flex-col h-full w-full md:max-h-[250px]">
      <div className="flex items-center gap-1 sm:gap-1.5 mb-1.5 sm:mb-2 lg:mb-1.5">
        ...
        <img 
          ...
          height="40"
        />
        <h3 className="text-sm sm:text-base lg:text-lg font-extrabold text-gray-900">System Check</h3>
      </div>
      
      <div className="flex-1 flex flex-col">
        {/* Status Indicators - Horizontal Layout with Labels Below */}
        <div className="flex items-center justify-around mb-2 sm:mb-3 lg:mb-2">
          {/* Video */}
          <div className="flex flex-col items-center gap-0.5 sm:gap-1 lg:gap-0.5">
            <img 
              ...
              height="40"
            />
            <span className="font-extrabold text-gray-900 text-[10px] sm:text-xs lg:text-xs">Video</span>
          </div>
          ...
          <div className="flex flex-col items-center gap-0.5 sm:gap-1 lg:gap-0.5">
            <img 
              ...
              height="40"
            />
            <span className="font-extrabold text-gray-900 text-[10px] sm:text-xs lg:text-xs">Audio</span>
          </div>
          ...
          <div className="flex flex-col items-center gap-0.5 sm:gap-1 lg:gap-0.5">
            <img 
              ...
              height="40"
            />
            <span className="font-extrabold text-gray-900 text-[10px] sm:text-xs lg:text-xs">Network</span>
          </div>
        </div>
