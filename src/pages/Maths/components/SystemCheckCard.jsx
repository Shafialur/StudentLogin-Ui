...
const SystemCheckCard = () => {
  return (
    <div className="system-check-card-exact rounded-2xl p-4 sm:p-5 md:p-6 card-shadow" style={{ height: '100%', width: '100%' }}>
      <div className="flex items-center gap-2 mb-3 md:mb-4">
        ...
        />
        <h3 className="text-xl sm:text-xl md:text-2xl font-bold text-gray-900">System Check</h3>
      </div>
