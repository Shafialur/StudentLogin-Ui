  ...
  return (
    <div className="bg-teacher-card backdrop-blur-sm md:backdrop-blur-md backdrop-saturate-[150%] border-2 border-gray-300 rounded-2xl p-2.5 sm:p-3 md:p-3 relative h-full w-full">
      ...
      <div className="absolute top-1.5 right-1.5 sm:top-2 sm:right-2 md:top-2 md:right-2 flex gap-1 sm:gap-2 z-10">
        <motion.svg
          className="w-2.5 h-2.5 sm:w-3 sm:h-3 md:w-5 md:h-5 text-purple-400"
          fill="currentColor"
          viewBox="0 0 20 20"
      ...
      <h3 className="text-sm sm:text-base md:text-lg font-extrabold text-gray-900 mb-1.5 sm:mb-2 md:mb-1.5">A Note from Your Teacher</h3>

      <div className="flex items-start gap-2 sm:gap-3 md:gap-4">
        {/* Teacher Avatar */}
        <div className="flex-shrink-0 flex flex-col items-center">
          <div
            className="w-12 h-12 sm:w-14 sm:h-14 md:w-14 md:h-14 bg-yellow-300 rounded-full flex items-center justify-center border-2 sm:border-3 md:border-2 border-white overflow-hidden"
          ...
          <h4 className="font-extrabold text-gray-900 text-[10px] sm:text-xs md:text-xs mt-0.5 sm:mt-1 md:mt-0.5">Ms. Guru</h4>
        </div>

        {/* Message Box - Full Width */}
        <div className="flex-1 min-w-0">
          <div className="bg-gray-100 rounded-lg p-2 sm:p-3 md:p-3 w-full h-full">
            <p className="text-gray-900 text-[10px] sm:text-xs md:text-xs font-bold leading-relaxed">
