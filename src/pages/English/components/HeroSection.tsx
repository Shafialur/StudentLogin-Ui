  ...
  return (
    <div className="relative w-full overflow-x-hidden m-0 p-0">
      ...
      <div className="relative w-full min-h-[320px] sm:min-h-[360px] lg:h-[36vh] bg-english-gradient overflow-hidden rounded-b-hero-bottom-mobile lg:rounded-b-hero-bottom-desktop lg:min-h-[320px] lg:max-h-[340px]">
        ...
        {decorReady && (
          <motion.div
            className="absolute bottom-0 left-24 w-80 h-auto object-contain opacity-100 pointer-events-none lg:hidden"
            style={{ zIndex: 20 }}
            animate={{ 
              y: [0, -5, 0]
            }}
        ...
        {decorReady && (
          <motion.img 
            ...
            alt="English cat" 
            className="absolute bottom-0 left-0 w-24 h-auto object-contain opacity-100 pointer-events-none lg:hidden"
            style={{ zIndex: 21 }}
            animate={{ 
              y: [0, -5, 0]
            }}
              ...
              <div className="w-full flex flex-col lg:flex-row items-center gap-3 lg:gap-6 lg:gap-8 px-4 lg:px-6 h-full overflow-visible">
                ...
                >
                  <h1 className="text-2xl lg:text-3xl xl:text-4xl 2xl:text-5xl font-black mb-2 lg:mb-3 xl:mb-4 leading-tight text-white text-center lg:text-left font-rounded tracking-tight w-full" style={{ textShadow: '0 2px 4px rgba(0, 0, 0, 0.3)', fontWeight: 900, wordWrap: 'break-word', overflowWrap: 'break-word', lineHeight: '1.1', fontSize: 'clamp(1.75rem, 2vw + 1rem, 4rem)' }}>
                    Hi, {childName || 'Krishna'}! <br className="hidden lg:block" />
                   Ready for English Journey - <br className="hidden lg:block" />Master Mind?
                  </h1>
        ...
        {decorReady && (
          <motion.img 
            ...
            alt="English cloud" 
            className="absolute top-8 left-1/2 -translate-x-1/2 w-28 lg:w-32 xl:w-36 h-auto object-contain opacity-80 pointer-events-none hidden lg:block"
            style={{ zIndex: 18 }}
            animate={{ 
              x: [0, 15, 0],
              y: [0, 5, 0]
        ...
        {decorReady && (
          <motion.div
            className="absolute top-8 left-[45%] w-20 lg:w-24 xl:w-28 h-auto object-contain opacity-100 pointer-events-none hidden lg:block"
            style={{ zIndex: 19 }}
            animate={{ 
              y: [0, -5, 0],
              rotate: [0, 2, -2, 0]
        ...
        {decorReady && (
          <motion.img 
            src="/images/eng-cloud.png" 
            alt="English cloud" 
            className="absolute top-8 right-[30%] w-24 lg:w-28 xl:w-32 h-auto object-contain opacity-75 pointer-events-none hidden lg:block"
            style={{ zIndex: 18 }}
            animate={{ 
              x: [0, -15, 0],
              y: [0, 8, 0]
        ...
        {decorReady && (
          <motion.img 
            src="/images/eng-cloud.png" 
            alt="English cloud" 
            className="absolute top-8 right-0 w-[120px] lg:w-36 xl:w-40 h-auto object-contain opacity-80 pointer-events-none hidden lg:block"
            style={{ zIndex: 18 }}
            animate={{ 
              x: [0, 20, 0],
              y: [0, 5, 0]
