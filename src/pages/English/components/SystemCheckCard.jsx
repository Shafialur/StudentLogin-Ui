...
const SystemCheckCard = () => {
  return (
    <div className="bg-system-card backdrop-blur-sm md:backdrop-blur-md backdrop-saturate-[150%] border-2 border-gray-300 rounded-2xl p-2.5 sm:p-3 md:p-3 flex flex-col h-full w-full md:max-h-[250px]">
